...
const MenuDriverList: React.FC<MenuDriverListProps> = ({
	...
	return (
		<div className="w-full px-3">
			<h2
				className={`font-futosans uppercase text-3xl tracking-wide mb-6 ${
							...
							<div className="flex items-center">
								...
								<span>
									<span
										className={
											secondName
												? "font-futosans uppercase"
												: "font-futosans uppercase font-bold italic"
										}
									>
										{firstName}
									</span>
									{secondName && (
										<span className="font-futosans uppercase italic font-bold ml-1">
											{secondName}
										</span>
									)}
								</span>

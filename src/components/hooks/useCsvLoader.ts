        ...
        const loadData = async () => {
            ...
            if (shouldProcess) {
                ...
                try {
                    ...
                    const teamsWithChanges = calculatePositionChanges(currentData.teams || [], oldData.teams || []);
                    const driversWithChanges = calculatePositionChanges(currentData.drivers || [], oldData.drivers || []);

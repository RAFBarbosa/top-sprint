...
export function Footer() {
	return (
		<footer className="bg-f1-silver py-6 text-white mt-auto">
			<div className="flex flex-col-reverse md:flex-row justify-between items-center md:max-w-screen-xl mx-auto px-3">
				<div className="flex md:flex-col items-center md:items-start gap-2 md:gap-0">
					...
					<p className="font-light text-sm md:-translate-y-2">
						Brazuka - Todos os direitos reservados
					</p>
				</div>
				<div className="md:hidden h-[.5px] w-full bg-f1-black/50 my-6" />
				<div className="flex flex-col items-center gap-4 md:gap-2">
					...
					<div className="md:self-end space-x-2">
						<SocialIcon
							className="bg-f1-silver rounded-lg hover:bg-f1-black transition-colors duration-200 border-1 border-f1-black/50"
							network="whatsapp"
							target="_blank"
					...
					<div className="h-[.5px] w-[45px] bg-f1-black/50 my-2 self-end hidden md:block" />
				...
				<div className="order-first w-full md:hidden">
					<div className="md:hidden h-[.5px] bg-f1-black/50 my-6" />

...
export function TopSprintRules() {
	const racePoints = [
		"25 pontos",
		"22 pontos",
		"20 pontos",
				...
				<div className="w-full md:w-1/2 space-y-4 px-3">
					...
					<div>
						...
						<ul className="ml-5 list-disc space-y-1">
							...
							<li>
								Dias de Sprint: Ambos os grids invertidos + 35%
								corrida principal
							</li>
						</ul>
				...
				<div className="border-t-8 border-r-8 border-b-8 border-f1-red rounded-tr-3xl rounded-br-3xl pt-8 w-full">
					...
					<div className="w-full flex flex-col md:flex-row">
						<div className="space-y-2 mb-3 md:w-1/2 pr-4">
							...
							<ul className="list-disc ml-5">
								<li>
									Para evitar disputas importantes com
									reservas, a posição final de reservas será 4
									posições atrás da posição em que cruzaram a
									linha de chegada.
								</li>
								<li>
									Infrações cometidas pelo piloto reserva,
									serão aplicadas na pontuação final que ele
									irá ganhar para a equipe.
								</li>
				...
				<div className="flex flex-col md:flex-row md:gap-6 gap-2 pr-3">
					<div className="w-full md:w-1/2 space-y-2">
						...
						<div className="space-y-2">
							<p>
								<strong>
									As corridas precisam ser gravadas na camera
									onboard caso os pilotos queiram abrir
									tickets ou se defender.
								</strong>
							</p>
							<p>
								<strong>
						...
						<div>
							<ul className="list-disc ml-5">
								<li>
									<strong>Impacto Leve (-2 pontos)</strong>:
									Quando o piloto causar prejuízo momentâneo
									sem danos físicos ao carro do adversário.
									(Exemplo: Forçar o outro piloto para fora da
									pista perdendo posições ou tempo, ou rodar
									parcialmente o piloto.)
								</li>
								<li>
									<strong>Impacto Severo (-3 pontos)</strong>:
									Quando o piloto causar perda de controle do
									adversário sem danos físicos ao carro.
									(Exemplo: Fazer o adversário rodar e ficar
									na contramão, perder múltiplas posições ou
									perder diversos segundos.)
								</li>
								<li>
									<strong>Dano Material (-4 pontos)</strong>:
									Quando o incidente resultar em danos
									mecânicos (nível amarelo ou superior) que
									obriguem o adversário a realizar um pit stop
									não planejado.
								</li>
								<li>
									<strong>
										Incidente Crítico (-8 pontos)
									</strong>
									: Quando o piloto causar o abandono (NC -
									Não Completou) de outro competidor ou
									provocar danos severos em múltiplos carros.
								</li>
							</ul>
						</div>
						{/* <p>
					...
					<div className="w-full md:w-1/2 space-y-2">
						<div className="space-y-2 flex flex-col">
							...
							<p>
								Agravantes ou atenuntes de penalidades podem ser
								aplicados e estão detalhados no manual de
								regras.
							</p>
							{/* <p>
								<strong>

...
export const TENANTS: Record<TenantId, TenantConfig> = {
    topSprint: {
        ...
        grids: [
            {
                ...
                standingsBgClass: "bg-radial-[at_50%_150%] from-f1-red to-f1-carbon to-65%",
                standingsTitle: "",
            ...
            },
            {
                ...
                standingsBgClass: "bg-radial-[at_50%_100%] from-f1-academy-blue to-f1-academy to-100%",
        ...
        nav: {
            ticketUrl: "https://marvelous-barracuda-f24.notion.site/2d9a6519acc080199dc7e431afd52d5a?pvs=105",
            registrationUrl: "https://docs.google.com/forms/d/19PHr-9GcvGMmp0SU2Nva9PEWDlm4R6JHjkIKD_L-YiI/edit",
        },
        cssVars: {
        ...
        fallbackDriverPhoto: "https://us-west-2.graphassets.com/AEeXs9JBOTq6bJXaWi87dz/cmkyoezu6gp7508loqaon7skm",
        poweredBy: false,
    },
    feliplay: {
        id: "feliplay",
        ...
        grids: [
            {
                ...
                hoverPrimaryColor: "hover:bg-f1-lightCarbon hover:text-white",
                hoverAccentColor: "hover:bg-f1-red hover:text-white",
                standingsBgClass: "bg-radial-[at_50%_100%] from-f1-silver to-f1-text to-70%",
                standingsTitle: "",
                countdownBgClass: "bg-f1-silver",
                cardBackground: feliplay,
            },
        ],
        features: { tickets: true, hallOfFame: true, partners: true, archive: false },
        nav: { ticketUrl: "https://docs.google.com/forms/d/e/1FAIpQLSfHN50Fhz16wKABFaKlBa-iLFSeDVENnuZyZ7pK40qXJkL5Nw/viewform" },
        cssVars: {
        ...
        fallbackDriverPhoto: "https://us-west-2.graphassets.com/cm9gqv6wb00c308jm0yap9zb6/cmam4ddx7kgoc08n61eyqeq84",
        poweredBy: true,
    },
    brazuka: {
        id: "brazuka",
        ...
        grids: [
            ...
            },
            {
                ...
                hoverAccentColor: "hover:bg-f1-red hover:text-white",
                standingsBgClass: "bg-radial-[at_50%_150%] from-f1-darkerRed to-f1-lightSilver to-225%",
            ...
            },
            {
                ...
                hoverPrimaryColor: "hover:bg-f1-academy-blue hover:text-white",
                hoverAccentColor: "hover:bg-f1-academy-dark hover:text-white",
                standingsBgClass: "bg-radial-[at_50%_100%] from-f1-academy-blue to-f1-darkerBlue to-150%",
                standingsTitle: "Charlie",
                countdownBgClass: "bg-f1-academy-darkerBlue",
                cardBackground: brazukaF2,
            },
        ],
        features: { tickets: false, hallOfFame: true, partners: false, archive: true },
        ...
        socials: { instagram: "https://www.instagram.com/brazukaracingleague/", youtube: "https://www.youtube.com/@BrazukaF1" },
        fallbackDriverPhoto: "https://us-west-2.graphassets.com/AEeXs9JBOTq6bJXaWi87dz/cmkyoezu6gp7508loqaon7skm",
        poweredBy: true,
    },
};
